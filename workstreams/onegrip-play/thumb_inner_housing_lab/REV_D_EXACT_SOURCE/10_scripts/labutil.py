...
Copied again so that LAB resolves to REV_D_EXACT_SOURCE.
REV_A / REV_B / REV_C are immutable.

READ-ONLY outside thumb_inner_housing_lab/REV_D_EXACT_SOURCE.  Never imports a production
...
LAB = Path(__file__).resolve().parents[1]          # -> REV_D_EXACT_SOURCE
