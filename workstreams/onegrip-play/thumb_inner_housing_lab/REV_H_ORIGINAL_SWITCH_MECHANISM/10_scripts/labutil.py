...
Copied again so that LAB resolves to REV_H_ORIGINAL_SWITCH_MECHANISM.
REV_A..REV_G are immutable.

READ-ONLY outside thumb_inner_housing_lab/REV_H_ORIGINAL_SWITCH_MECHANISM.  Never imports a production
...
LAB = Path(__file__).resolve().parents[1]          # -> REV_H_ORIGINAL_SWITCH_MECHANISM
