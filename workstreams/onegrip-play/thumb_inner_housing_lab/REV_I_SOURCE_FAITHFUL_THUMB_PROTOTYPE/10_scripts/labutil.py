...
Copied again so that LAB resolves to REV_I_SOURCE_FAITHFUL_THUMB_PROTOTYPE.
REV_A..REV_H are immutable.

READ-ONLY outside thumb_inner_housing_lab/REV_I_SOURCE_FAITHFUL_THUMB_PROTOTYPE.  Never imports a production
...
LAB = Path(__file__).resolve().parents[1]          # -> REV_I_SOURCE_FAITHFUL_THUMB_PROTOTYPE
