"""A16 - confirm every Thumb authority source is byte-identical to the baseline."""
...
def main() -> int:
    base = json.loads((L.LAB / "00_admin" / "SOURCE_BASELINE.json").read_text(encoding="utf-8"))["files"]
    bad, rows = 0, {}
    ...
    L.write_json(L.LAB / "00_admin" / "a16_source_check.json",
