...
Copied again so that LAB resolves to REV_F_RIGID_FIT.
REV_A..REV_E are immutable.

READ-ONLY outside thumb_inner_housing_lab/REV_F_RIGID_FIT.  Never imports a production
...
LAB = Path(__file__).resolve().parents[1]          # -> REV_F_RIGID_FIT
