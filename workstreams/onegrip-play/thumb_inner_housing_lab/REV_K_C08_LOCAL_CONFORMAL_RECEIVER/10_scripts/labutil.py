...
Copied again so that LAB resolves to REV_K_C08_LOCAL_CONFORMAL_RECEIVER.
REV_A..REV_H are immutable.

READ-ONLY outside thumb_inner_housing_lab/REV_K_C08_LOCAL_CONFORMAL_RECEIVER.  Never imports a production
...
LAB = Path(__file__).resolve().parents[1]          # -> REV_K_C08_LOCAL_CONFORMAL_RECEIVER
