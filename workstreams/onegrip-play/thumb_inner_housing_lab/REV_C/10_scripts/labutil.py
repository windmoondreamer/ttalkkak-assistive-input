...
Copied again so that LAB resolves to REV_C.  REV_A and REV_B are immutable.

READ-ONLY outside thumb_inner_housing_lab/REV_C.  Never imports a production
...
LAB = Path(__file__).resolve().parents[1]          # -> REV_C
