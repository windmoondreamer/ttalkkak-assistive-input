...
Copied again so that LAB resolves to REV_J_DOCS101_REVALIDATION.
REV_A..REV_H are immutable.

READ-ONLY outside thumb_inner_housing_lab/REV_J_DOCS101_REVALIDATION.  Never imports a production
...
LAB = Path(__file__).resolve().parents[1]          # -> REV_J_DOCS101_REVALIDATION
