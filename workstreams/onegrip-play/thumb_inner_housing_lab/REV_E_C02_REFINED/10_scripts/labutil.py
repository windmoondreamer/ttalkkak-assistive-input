...
Copied again so that LAB resolves to REV_E_C02_REFINED.
REV_A / REV_B / REV_C / REV_D are immutable.

READ-ONLY outside thumb_inner_housing_lab/REV_E_C02_REFINED.  Never imports a production
...
LAB = Path(__file__).resolve().parents[1]          # -> REV_E_C02_REFINED
