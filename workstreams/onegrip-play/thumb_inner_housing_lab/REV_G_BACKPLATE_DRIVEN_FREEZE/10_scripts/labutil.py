...
Copied again so that LAB resolves to REV_G_BACKPLATE_DRIVEN_FREEZE.
REV_A..REV_F are immutable.

READ-ONLY outside thumb_inner_housing_lab/REV_G_BACKPLATE_DRIVEN_FREEZE.  Never imports a production
...
LAB = Path(__file__).resolve().parents[1]          # -> REV_G_BACKPLATE_DRIVEN_FREEZE
