...
RETAINER_X_MM = (3.0, BASE_X_MM - 3.0)
...
7. cap pad를 누른다. rest에서 clip은 cavity roof에 걸려 cap을 유지하고, {config.hard_stop_travel_mm:.3f} mm 후 clip 하단과 cap pad 하단이 동시에 printed deck에 닿아 hard stop을 만든다.
