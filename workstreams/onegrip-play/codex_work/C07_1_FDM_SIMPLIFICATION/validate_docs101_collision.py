...
def main() -> int:
    ...
    core, _ = L.as_single_solid(import_step(str(CAND)), "C07_1")
    print("C07.1: vol %.3f mm3, %d faces" % (L.vol(core), len(list(core.faces()))))
